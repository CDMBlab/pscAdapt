...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default='D:/experiments/process_data/cross_platform/pbmcsca_10x_Chromium_CEL-Seq2/')

    parser.add_argument('--result_path', type=str, default='./results/')
    parser.add_argument('--num_iterations_pre', type=int, default=1001, help="num_iterations_pre")
    parser.add_argument('--num_iterations', type=int, default=25010, help="num_iterations")
    ...
    parser.add_argument('--alpha', type=float, default=1.0, metavar='ALPHA', help='regularization coefficient for VAT loss')
    parser.add_argument('--xi', type=float, default=10.0, metavar='XI', help='hyperparameter of VAT')
    parser.add_argument('--eps', type=float, default=1.0, metavar='EPS', help='hyperparameter of VAT')
    parser.add_argument('--ip', type=int, default=1, metavar='IP', help='hyperparameter of VAT')
    parser.add_argument('--quan', type=int, help='hyperparameter of similarity')
    parser.add_argument('--gpu_id', type=str, nargs='?', default='0', help="device id to run")
    args = parser.parse_args()
    os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu_id  #'0,1,2,3'
    print(args)
    data_set = preprocess(args)
    pscAdapt(args, data_set=data_set)
